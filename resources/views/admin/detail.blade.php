                  ...
                  <div class="content_wrap">
                     <div class="breadcrumbs">
                       <a href="{{route('admin.dashboard')}}">Home</a>
                        ...
                        <span class="breadcrumbs_delimiter"></span>
                        <span class="breadcrumbs_item current">Glock Double 9mm 3.4&#8243; 6+1 FS Integral</span>
                     </div>
                  </div>
               </div>
            </div>
                           ...
                           <div class="woocommerce-product-gallery woocommerce-product-gallery--with-images woocommerce-product-gallery--columns-4 images" data-columns="4" style="opacity: 0; transition: opacity .25s ease-in-out;">
                              <figure class="woocommerce-product-gallery__wrapper">
                                 <div data-thumb="{{asset('images/'. $product->image)}}" class="woocommerce-product-gallery__image">
                                    ...
                                    <img src="{{asset('images/'. $product->image)}}" alt="" title="" data-src="http://placehold.it/640x640.jpg" data-large_image="{{asset('images/'. $product->image)}}" data-large_image_width="640" data-large_image_height="640" />
                                    </a>
                                 </div>
                              </figure>
                           </div>
                           ...
                           <div class="summary entry-summary">
                             ...
                             <!--  <form class="cart" method="post" enctype="multipart/form-data">
                                ...
                                <form action="{{ route('products.destroy',$product->id) }}" method="POST">
                                 <a class="button alt" href="{{ route('products.edit',$product->id) }}">Edit</a>
                                 @csrf
                                 @method('DELETE')
